...
namespace Microsoft.Windows.Controls
{
    ...
    public partial class AutoCompleteBox : Control, IUpdateVisualState
    {
        ...
        /// </summary>
        public const string ElementSelectionAdapter = "SelectionAdapter";

        /// <summary>
        /// Specifies the name of the ToggleButton TemplatePart.
        /// </summary>
        public const string ElementDropDownToggle = "DropDownToggle";

        /// <summary>
        /// Specifies the name of the Popup TemplatePart.
        /// </summary>
        public const string ElementPopup = "Popup";
        
        /// <summary>
        /// The name for the text box part.
        /// </summary>
        public const string ElementTextBox = "Text";
        ...
        /// </summary>
        public bool UserCalledPopulate { get; set; }
        ...
        {
//            Console.WriteLine("OnSelectedItemPropertyChanged");
            AutoCompleteBox source = d as AutoCompleteBox;
        ...
        {
//            Console.WriteLine("Invoking text updated");
            AutoCompleteBox source = d as AutoCompleteBox;
            if (source != null) source.TextUpdated((string)e.NewValue, false);
            else
            {
                throw new Exception("Could not get source!");
            }
        }
        ...
        private static object RoutedEvents;
        ...
        {
//            Console.WriteLine(">>>>>>>>>>>>in :" + MethodBase.GetCurrentMethod().Name);
        ...
        private void UpdateTextCompletion(bool userInitiated)
        {
            ...
            if (View.Count > 0)
            {
                if (IsTextCompletionEnabled && TextBox != null && userInitiated)
                {
                    ...
                    if (selectionStart == text
                        .Length && selectionStart > TextSelectionStart)
                    {
